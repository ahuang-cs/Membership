...
class TrainingSession
{
  ...
  ])
  {
    ...
    $getSessions = nezamy_app()->db->prepare("SELECT SessionID FROM sessions WHERE Tenant = :tenant AND DisplayFrom <= :today AND DisplayUntil >= :today AND SessionDay = :sday ORDER BY StartTime ASC, EndTime ASC;");
    $getSessions->execute([
