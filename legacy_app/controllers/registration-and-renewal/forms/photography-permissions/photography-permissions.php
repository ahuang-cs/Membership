...
<div class="container">
  ...
  <div class="row justify-content-between">
    <div class="col-lg-8">
      ...
      <p>
        Please read the Swim England/<?= htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME')) ?> Photography Policy before you continue to give or withold consent for photography.
      </p>

      <p>
        <?= htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME')) ?> may wish to take photographs of individuals and groups of swimmers under the age of 18, which may include your child during their membership of <?= htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME')) ?>. Photographs will only be taken and published in accordance with Swim England policy which requires the club to obtain the consent of the Parent or Guardian to take and use photographs under the following circumstances.
      </p>
