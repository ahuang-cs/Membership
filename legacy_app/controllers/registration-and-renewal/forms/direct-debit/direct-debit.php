  ...
  <div class="row justify-content-between">
    <div class="col-lg-8">
      ...
      <form method="post" class="needs-validation" novalidate>
          ...
          do { ?>
            <div class="card card-body mb-3">
              <h2><?php if ($used) { ?>Your Direct Debit Mandate<?php $user = false;
                                                              } else { ?>Old Mandate<?php } ?> <span class="badge badge-secondary"><?php if ($mandate['Status'] == 'pending') { ?>Pending<?php } else if ($mandate['Status'] == 'accepted') { ?>Active<?php } ?></span></h2>
              <dl class="row">
        ...
        <?php if (true || (!$hasStripeMandate && nezamy_app()->tenant->getBooleanKey('ALLOW_DIRECT_DEBIT_OPT_OUT'))) { ?>
