...
if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LoggedIn']) && bool($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LoggedIn'])) {
  ...
  $this->group('/locations', function () {
    if (nezamy_app()->user->hasPermission('Admin')) {
...
$this->group('/check-in', function () {
  ...
  if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['ContactTracingSuccess']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['ContactTracingSuccess']) {
