  ...
  <div class="row">
    <div class="col-lg-8">
      <form method="post" class="needs-validation" novalidate>
        ...
        <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NewLocationSuccess'])) { ?>
        ...
        <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NewLocationSuccess']);
        } ?>

        <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UpdateLocationSuccess'])) { ?>
          <div class="alert alert-success">
            <p class="mb-0">
              <strong>Success</strong>
            </p>
        ...
        <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UpdateLocationSuccess']);
        } ?>

        <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UpdateLocationError'])) { ?>
          <div class="alert alert-danger">
            <p class="mb-0">
              <strong>Error</strong>
            </p>
            <p class="mb-0">
              <?= htmlspecialchars($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UpdateLocationError']) ?>
            </p>
          </div>
        <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UpdateLocationError']);
        } ?>
