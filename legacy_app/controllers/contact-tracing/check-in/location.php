...
$isUserMember = false;
if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LoggedIn']) && bool($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LoggedIn'])) {
  ...
  $getEqualCount->execute([
    nezamy_app()->user->getId(),
    nezamy_app()->user->getForename(),
    nezamy_app()->user->getSurname(),
  ]);
  ...
  <div class="container">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LoggedIn']) && bool($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LoggedIn'])) { ?>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-8">
      ...
      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['ContactTracingError']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['ContactTracingError']) { ?>
        <div class="alert alert-danger">
          <p class="mb-0">
            <strong>An error occurred</strong>
          </p>
          <p class="mb-0">
            <?= htmlspecialchars($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['ContactTracingError']['message']) ?>
          </p>
        </div>
      <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['ContactTracingError']);
      } ?>
        ...
        <form method="post" class="needs-validation" novalidate>
          ...
          <div class="cell <?php if ($isUserMember) { ?>d-none<?php } ?>">
            ...
            <div class="custom-control custom-checkbox">
              ...
              <label class="custom-control-label" for="user"><?= htmlspecialchars(nezamy_app()->user->getName()) ?></label>
            </div>
          </div>
...
$footer->addJs('js/contact-tracing/check-in.js');
$footer->render();
