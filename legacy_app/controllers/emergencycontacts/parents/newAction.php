...
if ($_POST['name'] != null && $_POST['name'] != "" && $_POST['num'] != null && $_POST['num'] != "") {
	try {
		...
		$_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AddNewSuccess'] = '
		...
		$_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AddNewError'] = '
		...
		';
		$_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['POST_DATA'] = $_POST;
