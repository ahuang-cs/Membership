...
$v = null;
if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['POST_DATA'])) {
  $v = $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['POST_DATA'];
  unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['POST_DATA']);
} else {
  $v = [
    'name' => '',
    'relation' => '',
...
<div class="container">
  ...
  <div class="">
    ...
    <div class="row">
      ...
      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AddNewError'])) {
			echo $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AddNewError'];
			unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AddNewError']);
		  } ?>
