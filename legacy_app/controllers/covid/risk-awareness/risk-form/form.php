...
<div class="bg-light mt-n3 py-3 mb-3">
  <div class="container">
    ...
    <div class="row align-items-center">
      <div class="col-lg-8">
        <h1>
          <?php if (mb_strtoupper(nezamy_app()->tenant->getKey('ASA_CLUB_CODE')) == 'UOSZ') { ?><?= htmlspecialchars(UOS_RETURN_FORM_NAME) ?><?php } else { ?>COVID-19 Risk Awareness Declaration<?php } ?> <small class="text-muted"><?= htmlspecialchars($member['MForename']) . '&nbsp;' . htmlspecialchars($member['MSurname']) ?></small>
        </h1>
        <p class="lead mb-0">
      ...
      <div class="col text-right">
        <?php if (mb_strtoupper(nezamy_app()->tenant->getKey('ASA_CLUB_CODE')) != 'UOSZ') { ?>
