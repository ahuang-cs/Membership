  ...
  <div class="row">
    <div class="col-lg-8">
      ...
      <form method="post" class="needs-validation" novalidate>
        ...
        <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AddSessionError'])) { ?>
          <div class="alert alert-danger">
            <p class="mb-0">
              <strong>An error occurred:</strong>
            </p>
            <p class="mb-0">
              <?= htmlspecialchars($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AddSessionError']) ?>
            </p>
          </div>
        <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AddSessionError']);
        } ?>
