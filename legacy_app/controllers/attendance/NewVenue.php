...
if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NewVenueError']['Data'])) {
  $venue_details = $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NewVenueError']['Data'];
}
...
<div class="container">
  <div class="row">
    <div class="col-lg-8">
      ...
      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NewVenueError']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NewVenueError']['Status']) { ?>
...
unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NewVenueError']);
