  ...
  <div class="container">
    ...
    <div class="row align-items-center">
      <div class="col-lg">
        ...
        <p class="lead mb-0">
          Venues used for sessions at <?= htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME')) ?>
        </p>
...
<div class="container">
  <div class="row">
    <div class="col-lg-8">
      ...
      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['EditVenueError']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['EditVenueError']['Status']) { ?>
      ...
      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['EditVenueSuccess']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['EditVenueSuccess']) { ?>
      ...
      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NewVenueSuccess']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NewVenueSuccess']) { ?>
        <div class="alert alert-success">
          <p class="mb-0">
            <strong>
...
unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['EditVenueError']);
unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['EditVenueSuccess']);
