...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-8 order-2 order-lg-1 mb-3">
      ...
      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['BookOnBehalfOfSuccess'])) { ?>
      ...
      <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['BookOnBehalfOfSuccess']); } ?>

      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['BookOnBehalfOfError'])) { ?>
      ...
      <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['BookOnBehalfOfError']); } ?>
