  ...
  foreach ($members as $member) {
    ...
    try {
      ...
      if (!$booking && isset($_POST['member-checkbox-' . $member['id']])) {
        ...
        $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['BookOnBehalfOfSuccess'] = true;
      }
    } catch (Exception $e) {
      $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['BookOnBehalfOfError'] = true;
    }
  }
}

if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['BookOnBehalfOfSuccess'])) {
