...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-8">
      ...
      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AssignListSuccess']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AssignListSuccess']) { ?>
      ...
      <?php
        unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AssignListSuccess']);
      } ?>

      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RemoveListSuccess']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RemoveListSuccess']) { ?>
      <div class="alert alert-success">
        <p class="mb-0">
          <strong>
      ...
      <?php
        unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RemoveListSuccess']);
      } ?>

      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RemoveListError']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RemoveListError']) { ?>
      ...
      <?php
        unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RemoveListError']);
      } ?>
