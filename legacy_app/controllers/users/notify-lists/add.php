...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-8">
      ...
      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AssignListError']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AssignListError']) { ?>
      ...
      <?php
        unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AssignListError']);
      } ?>
