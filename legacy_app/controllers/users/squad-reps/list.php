...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-8">
      ...
      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AssignSquadSuccess']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AssignSquadSuccess']) { ?>
      ...
      <?php
        unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AssignSquadSuccess']);
      } ?>

      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RemoveSquadSuccess']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RemoveSquadSuccess']) { ?>
      <div class="alert alert-success">
        <p class="mb-0">
          <strong>
      ...
      <?php
        unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RemoveSquadSuccess']);
      } ?>

      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RemoveSquadError']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RemoveSquadError']) { ?>
      ...
      <?php
        unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RemoveSquadError']);
      } ?>
