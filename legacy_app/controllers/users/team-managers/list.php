...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-8">
      ...
      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AssignGalaSuccess']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AssignGalaSuccess']) { ?>
      ...
      <?php
        unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AssignGalaSuccess']);
      } ?>

      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RemoveGalaSuccess']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RemoveGalaSuccess']) { ?>
      <div class="alert alert-success">
        <p class="mb-0">
          <strong>
      ...
      <?php
        unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RemoveGalaSuccess']);
      } ?>

      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RemoveGalaError']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RemoveGalaError']) { ?>
      ...
      <?php
        unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RemoveGalaError']);
      } ?>
