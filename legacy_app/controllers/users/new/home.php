...
{
  if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserCreationError']['fields'][$name])) {
    return $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserCreationError']['fields'][$name];
  }
  return '';
}
...
{
  if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserCreationError']['fields'][$name]) && bool($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserCreationError']['message'][$name])) {
    return 'checked';
  }
  return '';
}
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-8">
      ...
      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserCreationError'])) { ?>
        <div class="alert alert-danger">
          <p class="mb-0">
            <strong>We could not add the user</strong>
          </p>
          <p class="mb-0">
            <?= htmlspecialchars($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserCreationError']['message']) ?>
          </p>
        </div>
      <?php } ?>
...
if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserCreationError'])) unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserCreationError']);
