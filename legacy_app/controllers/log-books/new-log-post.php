...
if (sizeof($errors) > 0) {
  ...
  $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AddLogErrorMessage'] = $errorMessage;
  $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LogEntryOldContent'] = $_POST;
  ...
  try {
    ...
    $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AddLogSuccessMessage'] = $logId;
