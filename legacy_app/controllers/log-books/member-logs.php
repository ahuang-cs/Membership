...
<div class="container">
  ...
  <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AddLogSuccessMessage'])) { ?>
  <div class="alert alert-success">
    <p>
      <strong>Your new entry has been added to your training log.</strong>
    </p>
    <p class="mb-0">
      <a class="btn btn-success" href="<?=htmlspecialchars("#log-" . $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AddLogSuccessMessage'])?>">Jump to log</a>
    </p>
  </div>
  <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AddLogSuccessMessage']); } ?>

  <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SetMemberPassSuccess'])) { ?>
  <div class="alert alert-success">
    <p class="mb-0">
      <strong><?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LogBooks-MemberLoggedIn']) && bool($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LogBooks-MemberLoggedIn'])) { ?>We've saved your new password.<?php } else { ?>Member password updated.<?php } ?></strong>
    </p>
  </div>
  <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SetMemberPassSuccess']); } ?>
  ...
  <div class="row">
    ...
    <div class="col">
      <div class="position-sticky top-3">
        ...
        <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == 'Parent') { ?>
        <div class="cell">
          <h2>Member access</h2>
          <p class="lead">
