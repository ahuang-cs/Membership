...
if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == 'Parent' && $memberInfo['UserID'] != $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID']) {
  halt(404);
}
...
if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LogEntryOldContent']['title'])) {
  $title = $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LogEntryOldContent']['title'];
}
if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LogEntryOldContent']['entry'])) {
  $entry = $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LogEntryOldContent']['entry'];
}
if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LogEntryOldContent']['content-type'])) {
  $contentType = $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LogEntryOldContent']['content-type'];
}
if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LogEntryOldContent']['date'])) {
  $date = $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LogEntryOldContent']['date'];
}
if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LogEntryOldContent']['time'])) {
  $time = $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LogEntryOldContent']['time'];
}
if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LogEntryOldContent'])) {
  unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LogEntryOldContent']);
}
...
<form method="post" class="needs-validation" novalidate>
  ...
  <div class="bg-light mt-n3 py-3 mb-3">
    <div class="container">
      ...
      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LogBooks-MemberLoggedIn']) && bool($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LogBooks-MemberLoggedIn'])) { ?>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8">
        ...
        <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AddLogErrorMessage'])) { ?>
        <div class="alert alert-danger">
        <?=$_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AddLogErrorMessage']?>
        </div>
        <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AddLogErrorMessage']); } ?>
