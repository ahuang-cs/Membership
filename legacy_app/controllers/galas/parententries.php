...
$entries->execute([$_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID']]);
...
$timesheets->execute([$_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID']]);
...
<div class="front-page" style="margin-bottom: -1rem;">
  ...
  <nav aria-label="breadcrumb">
    ...
    <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['VetoTrue']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['VetoTrue']) { ?>
    ...
    <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['VetoTrue']); } ?>
