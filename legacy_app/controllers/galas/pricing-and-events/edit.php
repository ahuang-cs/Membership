...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-8">
      ...
      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['PricesSaved']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['PricesSaved']) { ?>
        <div class="alert alert-success">
          <p class="mb-0">
            <strong>Your changes have been saved successfully.</strong>
          </p>
        </div>
      <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['PricesSaved']); } ?>

      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['PricesNotSaved']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['PricesNotSaved']) { ?>
      ...
      <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['PricesNotSaved']); } ?>
