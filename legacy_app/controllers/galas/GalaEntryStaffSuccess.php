...
if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SuccessStatus'])) {
  include 'GalaEntryStaffSuccessCE.php';
  return;
}

if (!isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SuccessfulGalaEntry'])) {
  halt(404);
}
...
$get->execute([
  $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SuccessfulGalaEntry']['Swimmer'],
  $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SuccessfulGalaEntry']['Gala'],
  $tenant->getId()
]);
...
<div class="container">
  <div class="row">
    <div class="col-md-8">
      ...
      <?php if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SuccessfulGalaEntry']['HyTek']) { ?>
      <div class="cell">
      ...
      <div class="cell">
        ...
        <p class="mb-0">
          <a href="<?=autoUrl("swimmers/" . $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SuccessfulGalaEntry']['Swimmer'] . "/enter-gala")?>" class="btn btn-primary">
            Make another entry
          </a>
        </p>
      </div>
      ...
      <div class="cell">
        ...
        <p class="mb-0">
          ...
          <a href="<?=autoUrl("swimmers/" . $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SuccessfulGalaEntry']['Swimmer'])?>" class="btn btn-primary">
...
if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SuccessfulGalaEntry'])) {
  unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SuccessfulGalaEntry']);
}
