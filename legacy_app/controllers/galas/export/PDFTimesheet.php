...
if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == 'Parent') {
  $toHash .= $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID'];
}
$hash = hash('sha256', $toHash);

if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == "Parent") {
  $uid = $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID'];
...
<html>
  ...
  <body>
    ...
    <div class="primary-box mb-3" id="title">
      ...
      <p class="lead mb-0">Gala Timesheet Report<?php if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == "Parent") {?> for <?=htmlspecialchars(getUserName($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID']))?><?php } ?></p>
    ...
    <div class="avoid-page-break-inside">
      ...
      <p>Produced by Swimming Club Data Systems for <?=htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME'))?></p>
      <?php } ?>
    </div>
