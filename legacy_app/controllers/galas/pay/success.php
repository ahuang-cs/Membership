...
if (!isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['CompletedEntryInfo']) || !$_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['CompletedEntryInfo']) {
  halt(404);
}

if (!isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['GalaPaymentSuccess']) || !$_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['GalaPaymentSuccess']) {
  halt(404);
}
...
$getEntriesByPI->execute([
  $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['CompletedEntryInfo']
]);
...
unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['CompletedEntries']);
unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['CompletedEntryInfo']);
unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['GalaPaymentSuccess']);
