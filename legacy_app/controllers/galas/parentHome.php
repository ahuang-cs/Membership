...
$entries->execute([$nowDay, $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID']]);
...
$manualTimeGalas->execute([$nowDay, $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID']]);
...
$timesheets->execute([$nowDay, $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID']]);
