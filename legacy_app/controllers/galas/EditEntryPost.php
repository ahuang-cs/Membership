...
try {
  ...
  $message .= '<p>If you have any questions, please contact the ' . htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME')) . ' gala team as soon as possible.</p>';
  ...
  $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UpdateSuccess'] = true;
} catch (Exception $e) {
  $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UpdateError'] = true;
}
