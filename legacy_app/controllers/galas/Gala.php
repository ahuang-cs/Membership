...
if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == 'Parent') {
  ...
  $amountPaidQuery->execute([$id, 1, $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID']]);
  $amountPaid = $amountPaidQuery->fetchColumn();
  $amountPaidQuery->execute([$id, 0, $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID']]);
  ...
  $amountRefunded->execute([$id, $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID']]);
...
if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == "Parent") {
  ...
  $entries->execute([$id, $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID']]);
} else {
  $entries->execute([$id]);
}
...
<div class="container">
  ...
  <div class="row align-items-center">
    ...
    <?php if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == "Galas" || $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == "Committee" || $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == "Admin" || $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == "Coach") { ?>
  ...
  <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['GalaAddedSuccess']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['GalaAddedSuccess']) { ?>
  <div class="alert alert-success">We've successfully added this gala</div>
  <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['GalaAddedSuccess']); } ?>
  ...
  <div class="row">
    ...
    <div class="col-sm-6 col-md-4">
      <h3 class="h6"><?php if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == 'Parent') { ?>Total cost of your entries<?php } else { ?>Total cost of entries<?php } ?></h3>
      <p>&pound;<?=number_format($total, 2)?></p>
    </div>

    <?php if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] != 'Parent' && $amountLeftToPay > 0) { ?>
    <div class="col-sm-6 col-md-4">
      <h3 class="h6">Total left to charge</h3>
      <p>&pound;<?=number_format($amountLeftToPay, 2)?></p>
    </div>
    <?php } else if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] != 'Parent' && $amountRefunded > 0) { ?>
    <div class="col-sm-6 col-md-4">
    ...
    <?php if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == 'Parent' && $amountRefunded > 0) { ?>
    <div class="col-sm-6 col-md-4">
    ...
    <div class="col-sm-6 col-md-4">
      <h3 class="h6"><?php if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == 'Parent') { ?>Total refunded to you<?php } else { ?>Total refunded to parents<?php } ?></h3>
  ...
  <?php if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == 'Parent' && $gala['CoachEnters']) { ?>
  ...
  <?php } else if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == 'Coach' || $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == 'Galas' || $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == 'Admin') { ?>
