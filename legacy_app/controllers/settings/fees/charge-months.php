...
//nezamy_app()->tenant->setKey('SquadFeeMonths', '');

$squadFeeMonths = json_decode(nezamy_app()->tenant->getKey('SquadFeeMonths'), true);
  ...
  <div class="row justify-content-between">
    ...
    <div class="col-md-9">
      ...
      <main>
        ...
        <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['Update-Success']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['Update-Success']) { ?>
          <div class="alert alert-success">Changes saved successfully</div>
        <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['Update-Success']);
        } ?>

        <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['Update-Error']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['Update-Error']) { ?>
          <div class="alert alert-danger">Changes could not be saved</div>
        <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['Update-Error']);
        } ?>
