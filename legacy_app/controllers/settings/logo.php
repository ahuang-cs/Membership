...
<div class="container-fluid">
  <div class="row justify-content-between">
    ...
    <main class="col-md-9">
      ...
      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LOGO-SAVED']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LOGO-SAVED']) { ?>
        <div class="alert alert-success">New logo saved.</div>
        <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LOGO-SAVED']); } ?>

        <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LOGO-ERROR']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LOGO-ERROR']) { ?>
        <div class="alert alert-danger">Your new logo could not be saved.</div>
        <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LOGO-ERROR']); } ?>
