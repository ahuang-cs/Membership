  ...
  <div class="row justify-content-between">
    ...
    <div class="col-md-9">
      <main>
        ...
        <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['GC-Reg-Success'])) { ?>
        ...
        <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['GC-Reg-Success']);
        } ?>

        <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['GC-Reg-Error'])) { ?>
        ...
        <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['GC-Reg-Error']);
        } ?>

        <?php if ($at = nezamy_app()->tenant->getGoCardlessAccessToken()) { ?>
