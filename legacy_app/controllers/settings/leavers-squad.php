...
$leavers = nezamy_app()->tenant->getKey('LeaversSquad');
    ...
    <main class="col-md-9">
      ...
      <form method="post">
        ...
        <div id="leavers-squad-help">
          <p>
            Setting a leaver's squad allows parents to indicate a swimmer is leaving <?=htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME'))?>. This will remove the swimmer on the first day of the next calendar month.
          </p>
          <p>
