...
$at = nezamy_app()->tenant->getStripeAccount();
  ...
  <div class="row justify-content-between">
    ...
    <div class="col-md-9">
      <main>
        ...
        <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['Stripe-Reg-Success'])) { ?>
        ...
        <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['Stripe-Reg-Success']);
        } ?>

        <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['Stripe-Reg-Error'])) { ?>
        ...
        <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['Stripe-Reg-Error']);
        } ?>
