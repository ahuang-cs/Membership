      ...
      <div class="col-lg-8">
        <div class="">
          <form method="post" class="needs-validation" novalidate>
            ...
            <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RenewalErrorInfo'])) {
              echo $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RenewalErrorInfo'];
              unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RenewalErrorInfo']);
            } ?>
