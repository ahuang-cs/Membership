...
$paymentIntent = $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RegRenewalPaymentIntent'];
$reuse = 1;
...
if ($intent->status == 'succeeded') {
  $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RegRenewalPaymentDatabaseID'] = $databaseId;
  unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RegRenewalPaymentIntent']);
  unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RegRenewalPaymentMethodID']);
  unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AddNewCard']);

  $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RegRenewalPaymentSuccess'] = true;
  ...
  if ($renewal == 0 || user_needs_registration($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID'])) {
  ...
  unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RegRenewalID']);
