...
$userInfo->execute([$_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID']]);
...
<div class="container">
	<div class="">
		...
		<form method="post">
			...
			<?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AddNewSuccess'])) {
			echo $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AddNewSuccess'];
			unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AddNewSuccess']);
		} ?>

			<?php if (user_needs_registration($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID'])) { ?>
