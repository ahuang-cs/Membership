...
$terms_Id = nezamy_app()->tenant->getKey('TermsAndConditions');
...
$getInfo->execute([$_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID']]);
    ...
    <div class="col-lg-8">
      <form method="post" class="needs-validation" novalidate>
        ...
        <?php if (!$partial_reg) { ?>
          ...
          <?php echo mySwimmersTable(null, $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID']); ?>
        ...
        <p>
          ...
          purposes of <?= htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME')) ?>. Information will be disclosed only to
        ...
        <div class="form-group">
          <div class="custom-control custom-checkbox">
            ...
            <label class="custom-control-label" for="data-agree">
              I (<?= htmlspecialchars($name) ?>) agree to the use of my data by <?= htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME')) ?> as
              outlined above
            ...
            <div class="invalid-feedback">
              You must consent to the use of your data by <?= htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME')) ?>
            </div>
          </div>
        </div>
        ...
        <p>
          ...
          <?= htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME')) ?>, copies of which can be obtained from <a href="<?= htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_WEBSITE')) ?>" target="_blank">our website</a>. I confirm my
          ...
          <div class="cell">
            ...
            <div class="form-group <?php if ($age[$i] >= 12) {
              ...
              <div class="custom-control custom-checkbox">
                ...
                <label class="custom-control-label" for="<?= htmlspecialchars($id[$i]) ?>-tc-confirm">
                  ...
                  Conditions of <?= htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME')) ?> as outlined above
                </label>
                <div class="invalid-feedback">
            ...
            <?php if ($age[$i] < 12) { ?>
              ...
              <p>
                ...
                and Conditions of Membership of <?= htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME')) ?>.
              </p>
        ...
        if ($y > 0) { ?>
          ...
          <p>
            Please read the Swim England/<?= htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME')) ?> Photography Policy before you continue to
            give or withold consent for photography.
          </p>

          <p>
            <?= htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME')) ?> may wish to take photographs of individuals and groups of swimmers
            under the age of 18, which may include your child during their membership of
            <?= htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME')) ?>. Photographs will only be taken and published in accordance with Swim
