...
<div class="container">
	<form method="post" class="needs-validation" novalidate>
		...
		<div class="row">
			<div class="col-lg-8">
				<?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NewRenewalErrorInfo'])) {
					echo $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NewRenewalErrorInfo'];
					unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NewRenewalErrorInfo']);
					$val = $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NewRenewalForm'];
					unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NewRenewalForm']);
				} ?>
