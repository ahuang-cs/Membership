...
<div class="container">
  <div class="row">
    <div class="col-md-8">
      ...
      <p class="lead">This software is licenced to <?= htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME')) ?> by Swimming Club Data Systems.</p>
      ...
      <p class="lead">
        Something unclear? We can help.
      </p>

      <div class="card card-body mb-3">
        <h3 class="card-title">
          Contact <?= htmlspecialchars(nezamy_app()->tenant->getName()) ?> in the first instance
        </h3>

        <dl class="row mb-0">
          <dt class="col-sm-3">Email</dt>
          <dd class="col-sm-9 text-truncate mb-0"><a href="mailto:<?= htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_EMAIL')) ?>"><?= htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_EMAIL')) ?></a></dd>
        </dl>
      </div>

      <div class="card card-body mb-3">
        <h3 class="card-title">
          If further help is required, contact SCDS
        </h3>
      ...
      <div class="card card-body mb-3">
        <dl class="row mb-0">
          ...
          <?php if (nezamy_app()->user) { ?>
            <dt class="col-sm-3">User</dt>
            <dd class="col-sm-9 mono mb-0"><?= htmlspecialchars(nezamy_app()->user->getId()) ?></dd>
          <?php } else { ?>
            <dt class="col-sm-3">User</dt>
      ...
      <p>This application has been integrated with GoCardless and their APIs to allow <?= htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME')) ?> to bill members by Direct Debit. The GoCardless client library which is included in this software is copyright of GoCardless.</p>
