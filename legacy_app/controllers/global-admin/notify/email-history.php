...
`notifyHistory`.`ForceSend`, `Forename`, `Surname`, `JSONData`, `Date`, tenants.ID TenantID FROM
((`notifyHistory` LEFT JOIN `users` ON notifyHistory.Sender = users.UserID) INNER JOIN tenants ON notifyHistory.Tenant = tenants.ID) ORDER
...
$pagetitle = "Page " . $page . " - Notify Email History - Admin Dashboard - SCDS";
    ...
    <div class="col-lg-8 col-md-10">
      ...
      <?php } else { ?>
        ...
        <nav aria-label="Page navigation">
          <ul class="pagination">
            <?php if ($numMails <= 10) { ?>
              <li class="page-item active"><a class="page-link" href="<?php echo autoUrl("admin/notify/history?page="); ?><?php echo $page ?>"><?php echo $page ?></a></li>
            <?php } else if ($numMails <= 20) { ?>
              <?php if ($page == 1) { ?>
                <li class="page-item active"><a class="page-link" href="<?php echo autoUrl("admin/notify/history?page="); ?><?php echo $page ?>"><?php echo $page ?></a></li>
                <li class="page-item"><a class="page-link" href="<?php echo autoUrl("admin/notify/history?page="); ?><?php echo $page + 1 ?>"><?php echo $page + 1 ?></a></li>
                <li class="page-item"><a class="page-link" href="<?php echo autoUrl("admin/notify/history?page="); ?><?php echo $page + 1 ?>">Next</a></li>
              <?php } else { ?>
                <li class="page-item"><a class="page-link" href="<?php echo autoUrl("admin/notify/history?page="); ?><?php echo $page - 1 ?>">Previous</a></li>
                <li class="page-item"><a class="page-link" href="<?php echo autoUrl("admin/notify/history?page="); ?><?php echo $page - 1 ?>"><?php echo $page - 1 ?></a></li>
                <li class="page-item active"><a class="page-link" href="<?php echo autoUrl("admin/notify/history?page="); ?><?php echo $page ?>"><?php echo $page ?></a></li>
              <?php } ?>
            <?php } else { ?>
              <?php if ($page == 1) { ?>
                <li class="page-item active"><a class="page-link" href="<?php echo autoUrl("admin/notify/history?page="); ?><?php echo $page ?>"><?php echo $page ?></a></li>
                <li class="page-item"><a class="page-link" href="<?php echo autoUrl("admin/notify/history?page="); ?><?php echo $page + 1 ?>"><?php echo $page + 1 ?></a></li>
                <li class="page-item"><a class="page-link" href="<?php echo autoUrl("admin/notify/history?page="); ?><?php echo $page + 2 ?>"><?php echo $page + 2 ?></a></li>
                <li class="page-item"><a class="page-link" href="<?php echo autoUrl("admin/notify/history?page="); ?><?php echo $page + 1 ?>">Next</a></li>
              <?php } else { ?>
                <li class="page-item"><a class="page-link" href="<?php echo autoUrl("admin/notify/history?page="); ?><?php echo $page - 1 ?>">Previous</a></li>
                <?php if ($page > 2) { ?>
