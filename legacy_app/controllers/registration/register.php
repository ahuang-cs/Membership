...
$privacy = nezamy_app()->tenant->getKey('PrivacyPolicy');
...
<div class="pb-3">
  <div class="container">
      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RegistrationGoVerify'])) {
        echo $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RegistrationGoVerify'];
        unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RegistrationGoVerify']);
      }  else { ?>
      ...
      <form method="post" action="<?php echo autoUrl("register"); ?>" name="register" id="register" class="needs-validation" novalidate>
        ...
        <div class="row">
          <div class="col-md-10 col-lg-8">
            ...
            <div class="form-row">
              ...
              <div class="col">
                ...
                <div class="form-group">
                  ...
                  value="<?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RegistrationForename'])) { ?><?=htmlspecialchars($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RegistrationForename'])?><?php } ?>" autocomplete="given-name">
              ...
              <div class="col">
                ...
                <div class="form-group">
                  ...
                  value="<?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RegistrationSurname'])) { ?><?=htmlspecialchars($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RegistrationSurname'])?><?php } ?>" autocomplete="family-name">
                  <div class="invalid-feedback">
            ...
            <div class="form-group">
              ...
              <input class="form-control mb-0 text-lowercase" type="email" name="email" id="email-address" placeholder="yourname@example.com" required value="<?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RegistrationEmail'])) { ?><?=htmlspecialchars($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RegistrationEmail'])?><?php } ?>" autocomplete="email">
              <small id="emailHelp" class="form-text text-muted">
                Your email address will only be used inside <?=htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME'))?> and SCDS.
              </small>
              <div class="invalid-feedback">
        ...
        <div class="row">
          <div class="col-md-10 col-lg-8">
            <div class="form-group">
              ...
              <input class="form-control" type="tel" pattern="\+{0,1}[0-9]*" name="mobile" id="mobile" placeholder="01234 567890" required value="<?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RegistrationMobile'])) { ?><?=htmlspecialchars($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RegistrationMobile'])?><?php } ?>" autocomplete="tel">
        ...
        $email = $sms = "";
        if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RegistrationEmailAuth'])) {
          $email = " checked ";
          unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RegistrationEmailAuth']);
        }
        if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RegistrationSmsAuth'])) {
          $sms = " checked ";
          unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RegistrationSmsAuth']);
        } ?>
        ...
        <div class="row">
          <div class="col-md-10 col-lg-8">
            ...
            <div class="cell">
              ...
              <p>
                In accordance with European Law, <?=htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME'))?>, Swim England and British Swimming are Data Controllers for the purposes of the General Data Protection Regulation.
              </p>
              <p>
                By proceeding you agree to our <a href="https://www.chesterlestreetasc.co.uk/policies/privacy/" target="_blank">Privacy Policy (this is an example policy)</a> and the use of your data by <?=htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME'))?>. Please note that you have also agreed to our use of you and/or your swimmer's data as part of your registration with the club and with British Swimming and Swim England.
              </p>
              <p>
...
unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RegistrationForename']);
unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RegistrationSurname']);
unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RegistrationEmail']);
unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RegistrationMobile']);
