...
try {
  ...
  $checkExists->execute([$_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AC-UserDetails']['email-addr']]);
  ...
  if ($checkExists->fetchColumn() == 0) {
    ...
    try {
      ...
      $addUser->execute([
        $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AC-UserDetails']['password-hash'],
        'Parent',
        $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AC-UserDetails']['email-addr'],
        $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AC-UserDetails']['allow-email'],
        $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AC-UserDetails']['forename'],
        $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AC-UserDetails']['surname'],
        $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AC-UserDetails']['mobile'],
        $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AC-UserDetails']['allow-sms'],
        false
      ]);
    ...
    $getUser->execute([$_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AC-UserDetails']['email-addr']]);
  ...
  $getSwimmers->execute([$_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AC-Registration']['Hash']]);
...
$_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AC-Registration']['Stage'] = 'MedicalForm';
