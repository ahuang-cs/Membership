...
if ($success) {
  ...
  $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AC-Registration']['Stage'] = 'CodeOfConduct';
  ...
  $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AC-TC-Selected'] = $selections;
  $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AC-TC-ErrorNames'] = $name;
