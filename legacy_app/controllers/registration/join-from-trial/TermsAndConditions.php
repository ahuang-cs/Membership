  ...
  <div class="row">
    <div class="col-sm-10 col-md-8">
      <form method="post" class="needs-validation" novalidate>
        ...
        <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AC-TC-ErrorNames'])) { ?>
          <div class="alert alert-warning">
            ...
            <ul class="mb-0">
            <?php
            foreach ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AC-TC-ErrorNames'] as $name) {
              ?><li><?=$name?></li><?php
            }
            ?>
            </ul>
        ...
        <?php }
        unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AC-TC-ErrorNames']); ?>
        ...
        <p>
					...
					Rules and the Policies and Procedures Documentation of <?=htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME'))?>,
          ...
          <div class="form-group">
						<div class="custom-control custom-checkbox">
							...
							<label class="custom-control-label" for="<?=$id?>">
								...
								agree to the Terms and Conditions of <?=htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME'))?> as outlined
								above
							</label>
