...
$replyMe = false;
if (getUserOption($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID'], 'NotifyReplyAddress')) {
  $replyMe = true;
}
...
if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NotifyIndivPostContent']['from'])) {
  $from = $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NotifyIndivPostContent']['from'];
}
if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NotifyIndivPostContent']['ReplyToMe'])) {
  $reply = $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NotifyIndivPostContent']['ReplyToMe'];
}
if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NotifyIndivPostContent']['subject'])) {
  $subject = $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NotifyIndivPostContent']['subject'];
}
if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NotifyIndivPostContent']['message'])) {
  $content = $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NotifyIndivPostContent']['message'];
}
