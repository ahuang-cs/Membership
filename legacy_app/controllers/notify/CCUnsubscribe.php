...
<div class="container">
	...
	<p>
		For further help and support with emails from <?=htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME'))?>, visit
		our <a href="<?=autoUrl("notify")?>">Notify Help Centre</a>.
	</p>
	<p>
		Notify by <?=htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME'))?>
	</p>
</div>
