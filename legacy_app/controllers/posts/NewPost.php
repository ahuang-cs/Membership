			...
			<div class="col-md-8">
				<div>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" name="title" id="title" placeholder="Post Title" autocomplete="off" <?php if ($people) { ?>value="<?= getUserName($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID']) ?>" readonly <?php } ?>>
					</div>
