  ...
  <div class="row">
    <div class="col-lg-8">
      ...
      <form method="post">
        ...
        <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['CatChangesSaveError']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['CatChangesSaveError']) { ?>
        ...
        <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['CatChangesSaveError']); } ?> 

        <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['CatChangesSavedSuccessfully']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['CatChangesSavedSuccessfully']) { ?>
        ...
        <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['CatChangesSavedSuccessfully']); } ?> 
