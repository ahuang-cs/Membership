...
if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == 'Parent' && (!$user || $user->getId() != $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID'])) {
  halt(404);
}

$manageSquads = false;
if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == 'Admin' || $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == 'Coach') {
  $manageSquads = true;
}
  ...
  <div class="container-fluid">
    ...
    <div class="row align-items-center">
      ...
      <div class="text-lg-right col-lg">
        <?php if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == 'Parent' || $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == 'Admin') { ?>
          <p>
        ...
        <?php } ?>
        <?php if ($user && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] != 'Parent') { ?>
          <div class="dropdown">
...
<div class="container-fluid">
  ...
  <div class="row justify-content-between">
    ...
    <div class="col">
      ...
      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NewQualificationSuccess'])) { ?>
        <div class="alert alert-success">
          <p class="mb-0">
            <strong>New qualification added successfully</strong>
          </p>
        </div>
      <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NewQualificationSuccess']);
      } ?>

      <div id="qualifications-box" data-qualifications-url="<?= htmlspecialchars(autoUrl("members/$id/qualifications/current")) ?>"></div>

      <?php if (nezamy_app()->user->hasPermissions(['Admin'])) { ?>
        <p>
