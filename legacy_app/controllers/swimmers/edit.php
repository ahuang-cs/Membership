...
$admin = nezamy_app()->user->hasPermissions(['Admin', 'Coach']);
...
$isMemberUser = $row['UserID'] == nezamy_app()->user->getId();

if (!$admin && $row['UserID'] != nezamy_app()->user->getId()) {
  halt(404);
}
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-8">
      ...
      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SuccessState'])) { ?>
        <div class="alert alert-success">
          <p class="mb-0">
            <strong>Changes saved successfully</strong>
          </p>
        </div>
      <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SuccessState']);
      } ?>
      ...
      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['ErrorState'])) { ?>
        <div class="alert alert-danger">
          ...
          <p class="mb-0">
            <?= htmlspecialchars($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['ErrorState']) ?>
          </p>
        </div>
      <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['ErrorState']);
      } ?>
