  ...
  <form method="post">
    ...
    <div class="row">
      <div class="col-md-8">
        ...
        <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SwimmerSaved']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SwimmerSaved']) { ?>
          <div class="alert alert-success">
            <p class="mb-0">
              <strong>We have saved your changes</strong>
            </p>
          </div>
        <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SwimmerSaved']);
        } ?>

        <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SwimmerNotSaved']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SwimmerNotSaved']) { ?>
        ...
        <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SwimmerNotSaved']);
        } ?>
        ...
        <?php if ($age < 18) { ?>
          <div class="form-group">
            ...
            <p>
              I, <?php echo getUserName($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID']); ?> agree to photography of
