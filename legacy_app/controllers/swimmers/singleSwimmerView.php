...
if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NotifyIndivSuccess'])) {
...
<div class="mb-3 card" id="about">
  ...
  <div class="mb-3 card card-body" id="times">
    ...
    $mob = nezamy_app('request')->isMobile();
...
<div class="container-fluid">
  ...
  <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SwimmerAdded']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SwimmerAdded']) { ?>
  ...
  <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SwimmerAdded']); } ?>
