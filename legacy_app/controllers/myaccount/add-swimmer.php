...
if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == "Parent") { ?>
  <div class="container-fluid">
    ...
    <div class="row justify-content-between">
      ...
      <div class="col-md-9">
        <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AddSwimmerSuccessState'])) {
          echo $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AddSwimmerSuccessState'];
          unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AddSwimmerSuccessState']);
        } else if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['ErrorState'])) {
