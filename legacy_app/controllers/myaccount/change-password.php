...
<div class="container-fluid">
  <div class="row justify-content-between">
    ...
    <div class="col-md-9">
      ...
      if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['PasswordUpdate']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['PasswordUpdate']) { ?>
        <div class="alert alert-success">
          <strong>You've successfully changed your password</strong>
        </div>
      <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['PasswordUpdate']);
      } ?>
