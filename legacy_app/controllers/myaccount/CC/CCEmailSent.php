...
if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['VerifyEmailSent']) && bool($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['VerifyEmailSent'])) {
  unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['VerifyEmailSent']);
}
