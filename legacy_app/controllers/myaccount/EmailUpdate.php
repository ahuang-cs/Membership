...
if ($found) {
	...
	$message = '
	<p>Your ' . nezamy_app()->tenant->getKey('CLUB_NAME') . ' Account Email Address has been changed from ' . $oldEmail . ' to ' . $newEmail . '.</p>
	...
	$from = [
		...
		"Name" => nezamy_app()->tenant->getKey('CLUB_NAME') . " Secretary"
	];
