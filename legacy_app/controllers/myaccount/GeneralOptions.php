...
$notGalaDDChecked;
if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == "Parent" && $currentUser->getUserBooleanOption('GalaDirectDebitOptOut')) {
    ...
    <div class="col-md-9">
      ...
      <p class="lead">Manage cookies and 2FA.</p>
        ...
        <div class="cell">
          ...
          <?php if (filter_var(getUserOption($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID'], "Is2FA"), FILTER_VALIDATE_BOOLEAN) || $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] != "Parent") { ?>
          ...
          <?php if (!filter_var(getUserOption($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID'], "hasGoogleAuth2FA"), FILTER_VALIDATE_BOOLEAN)) { ?>
          <p>
        ...
        <div class="cell">
          ...
          <p>
            Under the General Data Protection Regulation, you can request for free to download all personal data held about you by <?=htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME'))?>.
          </p>
          <p>
