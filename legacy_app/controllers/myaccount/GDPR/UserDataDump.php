...
$acc_details->execute([$_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID']]);
...
fputcsv($output, array(nezamy_app()->tenant->getKey('CLUB_NAME') . ' User Data Download'));
