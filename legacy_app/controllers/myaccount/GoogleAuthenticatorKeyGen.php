...
if (!isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['G2FAKey'])) {
  $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['G2FAKey'] = $google2fa->generateSecretKey(32);
}
...
<div class="container">
  <div class="row">
    <div class="col-lg-8">
      ...
      <?php } ?>
      <p>
        Your Secret Key is <span class="mono"><?=$_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['G2FAKey']?></span>.
      </p>

      <h2>Scan Code</h2>
      <?php
      $qr_url = urlencode($google2fa->getQRCodeUrl(nezamy_app()->tenant->getKey('CLUB_NAME'), $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['EmailAddress'], $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['G2FAKey']));
      ?>
      ...
      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['G2FA_VerifyError']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['G2FA_VerifyError']) { ?>
