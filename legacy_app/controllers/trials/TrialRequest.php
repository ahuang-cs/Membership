...
if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['RequestTrintial-AddAnother'])) {
...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <?php if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['TrialAppointmentUpdated'] === true) { ?>
...
unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['TrialAppointmentUpdated']);
