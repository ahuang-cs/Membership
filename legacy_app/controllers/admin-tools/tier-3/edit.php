...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-8">
      ...
      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['FormSuccess'])) { ?>
        <div class="alert alert-success">
          Saved
        </div>
      <?php
        unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['FormSuccess']);
      } ?>

      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['FormError'])) { ?>
        <div class="alert alert-danger">
          <p class="mb-0">
            <strong>An error occurred</strong>
          </p>
          <p class="mb-0">
            <?= htmlspecialchars($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['FormError']) ?>
          </p>
        </div>
      <?php
