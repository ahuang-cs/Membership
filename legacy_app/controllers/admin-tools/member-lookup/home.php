...
if (isset($_GET['member-id'])) {
  try {
    $client = new \RankingsDB\RankingsClient(nezamy_app()->tenant->getKey('GLOBAL_PERSONAL_KEY'), (int) nezamy_app()->tenant->getKey('GLOBAL_PERSONAL_KEY_ID_NUMBER'));
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-8">
      ...
      <?php if (nezamy_app()->tenant->getKey('GLOBAL_PERSONAL_KEY') && (int) nezamy_app()->tenant->getKey('GLOBAL_PERSONAL_KEY_ID_NUMBER')) { ?>
