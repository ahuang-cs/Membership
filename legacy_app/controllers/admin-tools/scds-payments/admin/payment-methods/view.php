...
$db = nezamy_app()->db;
$tenant = nezamy_app()->adminCurrentTenant;
$user = nezamy_app()->adminCurrentUser;
  ...
  <div class="row align-items-center">
    ...
    <aside class="col-auto ml-auto">
      <?php if ($paymentMethod['Type'] == 'card') { ?>
        <img src="<?= htmlspecialchars(url("/img/stripe/" . $typeData->brand . ".png")) ?>" srcset="<?= htmlspecialchars(url("/img/stripe/" . $typeData->brand . "@2x.png")) ?> 2x, <?= htmlspecialchars(url("/img/stripe/" . $typeData->brand . "@3x.png")) ?> 3x" style="height:2.5rem;">
      <?php } else if ($paymentMethod['Type'] == 'bacs_debit') { ?>
        <img style="max-height:50px;" src="<?= htmlspecialchars(url("/img/directdebit/directdebit.png")) ?>" srcset="<?= htmlspecialchars(url("/img/directdebit/directdebit@2x.png")) ?> 2x, <?= htmlspecialchars(url("/img/directdebit/directdebit@3x.png")) ?> 3x" alt="Direct Debit Logo">
      <?php } ?>
    </aside>
  </div>
