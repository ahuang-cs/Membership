...
if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AssRegGuestUser'])) {
  if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AssRegStage'] == 1 || $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AssRegStage'] == 2) {
  ...
  } else if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AssRegStage'] == 3) {
