...
$getUser->execute([$_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AssRegGuestUser'], $rrRequirement]);
...
$getUserSwimmers->execute([$_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AssRegGuestUser']]);

$pagetitle = "Welcome to " . htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME')) . " - Assisted Registration";
...
<div class="container">
  <div class="row">
    <div class="col-md-8">
      ...
      <p class="lead">
        Welcome to <?= htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME')) ?>. Let's complete your account registration.
      </p>
