...
try {
  ...
  $email = $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AssRegUserEmail'];
  ...
  if ($info) {
    ...
    $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AssRegUser'] = $db->lastInsertId();
  ...
  $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AssRegPass'] = $password;
...
if ($status) {
  ...
  if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AssRegUserEmail'])) {
    unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AssRegUserEmail']);
  }
} else {
  $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AssRegFormError'] = true;
  $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AssRegPostData'] = $_POST;
