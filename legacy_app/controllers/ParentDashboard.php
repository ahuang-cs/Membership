...
<div class="front-page mb-n3">
  <div class="container">
    ...
    <?php if (!isSubscribed($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID'], 'Notify')) { ?>
      <aside class="row mb-4">
        <div class="col-lg-6">
          <div class="cell bg-primary text-white">
            ...
            <p>
              <strong>
                You're missing out on email updates from <?= htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME')) ?>
              </strong>
            </p>
            <p>
    ...
    <?php if (false && nezamy_app()->tenant->getGoCardlessAccessToken() && !userHasMandates($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID'])) { ?>
      <div class="mb-4">
        <h2 class="mb-4">Want to set up a Direct Debit?</h2>
        <div class="news-grid">
