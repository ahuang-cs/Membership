...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-8">
      ...
      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SquadAddError']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SquadAddError']) { ?>
        <div class="alert alert-danger">
          <p class="mb-0">
            <strong>There was a problem trying to add your new squad</strong>
          </p>
          <p class="mb-0">
            <?= htmlspecialchars($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SquadAddError']['message']) ?>
          </p>
        </div>
      <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SquadAddError']);
      } ?>
