...
<div class="front-page mb-n3">
	<div class="container">
		...
		<?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['DeleteSuccess']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['DeleteSuccess']) { ?>
			<div class="alert alert-success">We've deleted that squad. That action cannot be undone.</div>
		<?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['DeleteSuccess']);
		} ?>
