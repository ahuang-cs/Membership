    ...
    <div class="col-lg-8">
      <div class="">
        <form method="post" class="needs-validation" novalidate>
          ...
          <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UpdateDatabaseError']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UpdateDatabaseError']) { ?>
            <div class="alert alert-danger">A database error occured. We did not save the changes.</div>
          <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UpdateDatabaseError']);
          } ?>
