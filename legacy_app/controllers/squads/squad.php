...
$swimmers = null;
if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] != 'Parent' || $canAccessSquadInfo) {
...
<div class="container">
  <div class="row">
    <div class="col-lg-8">
      ...
      <?php if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] != "Parent" && $numSwimmers > 0) { ?>
        <h2>Sex Split</h2>
