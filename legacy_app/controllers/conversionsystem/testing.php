...
if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['Time'])) {
  $fluidContainer = true;
}
      ...
      <?php } else { ?>
        ...
        <div class="row">
                ...
                <table class="table table-sm table-striped">
                  <thead class="thead-light">
                    <tr>
                      ...
                      <th scope="col">Time (<?= htmlentities($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['Time']['Event']) ?>)</th>
                    </tr>
                  </thead>
                  <tbody>
          ...
          <div class="col">
            ...
            <div class="cell">
              <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['Time']['Error']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['Time']['Error']) { ?>
