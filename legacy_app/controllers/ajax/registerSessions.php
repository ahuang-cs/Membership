...
if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == "Committee" || $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == "Admin" || $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == "Coach") {
