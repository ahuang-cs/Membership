...
<div class="container">
  ...
  <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['MandateDeletedTrue']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['MandateDeletedTrue']) { ?>
  ...
  <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['MandateDeletedTrue']); } ?>
    ...
    <li class="list-group-item list-group-item-x">
      ...
      <div class="row align-items-center">
        <div class="col-12 col-md-4">
          <a target="_blank" download class="btn btn-block btn-dark" href="<?=htmlspecialchars(autoUrl("payments/mandates/" . $row['Mandate'] . '/print'))?>" title="View details about this mandate which are also visible to the user">
            View printable info
          </a>
