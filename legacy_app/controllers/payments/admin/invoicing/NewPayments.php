...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-8">
      ...
      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NewPaymentSuccessMessage'])) { ?>
        <div class="alert alert-success">
          <?= htmlspecialchars($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NewPaymentSuccessMessage']) ?>
        </div>
      <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NewPaymentSuccessMessage']);
      } ?>

      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NewPaymentErrorMessage'])) { ?>
        <div class="alert alert-danger">
          <p class="mb-0"><strong>An error occured and we have not added the payment</strong></p>
          <p class="mb-0"><?= htmlspecialchars($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NewPaymentErrorMessage']) ?></p>
        </div>
      <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NewPaymentErrorMessage']);
      } ?>
