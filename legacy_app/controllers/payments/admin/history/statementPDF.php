...
$_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['qr'][0]['text'] = autoUrl("payments/statements/" . htmlspecialchars($id));
...
<html>
  ...
  <body>
    ...
    <p>&copy; <?=htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME'))?> <?=date("Y", strtotime($payment_info['Date']))?></p>
