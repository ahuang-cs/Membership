  ...
  <div class="form-row">
    ...
    <div class="col-6">
      <div class="form-group">
        ...
        <input type="text" class="mono form-control" id="payment-name" name="payment-name" aria-describedby="payment-name-help" placeholder="eg <?=htmlspecialchars($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['Surname'])?>">
