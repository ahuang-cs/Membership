...
<div class="container">
	...
	<div class="row">
		<div class="col-md-8">
			...
			<?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['ChargeUsersSuccess'])) { 
				unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['ChargeUsersSuccess']); ?>
				<div class="alert alert-success">
					<strong>We've successfully refunded the parents</strong>
				</div>
			<?php } ?>

			<?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['ChargeUsersFailure'])) { 
				unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['ChargeUsersFailure']); ?>
				  ...
				  <form id="refund-form-<?=htmlspecialchars($entry['EntryID'])?>" novalidate autocomplete="off">
						<div class="row">
							...
							<div class="col">
								...
								<?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['OverhighChargeAmount'][$entry['EntryID']]) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['OverhighChargeAmount'][$entry['EntryID']]) {
									unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['OverhighChargeAmount'][$entry['EntryID']]); ?>
...
<?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['OverhighChargeAmount'])) {
	unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['OverhighChargeAmount']);
} ?>
