...
if ($checkIfCustomer->fetchColumn() == 0) {
  ...
  $customer = \Stripe\Customer::create(
    ...
    "description" => 'Generated by ' . $tenant->getName() . ' Membership',
...
if (!isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['StripeSetupIntentId'])) {
  ...
  $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['StripeSetupIntentId'] = $setupIntent->id;
} else {
...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-8">
      ...
      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['PayCardError'])) { ?>
      <div class="alert alert-danger">
        <p class="mb-0">
          <strong>An error occurred</strong>
        </p>
        <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['PayCardErrorMessage'])) { ?>
        <p class="mb-0"><?=htmlspecialchars($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['PayCardErrorMessage'])?></p>
        <?php } ?>
      </div>
      <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['PayCardError']); unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['PayCardErrorMessage']); ?>
      <?php } ?>
