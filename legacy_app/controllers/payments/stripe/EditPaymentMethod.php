...
$getCard->execute([$_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID'], $id]);
  ...
  <div class="row">
    <div class="col-md-8">
      <div class="row align-items-center mb-2 text-dark">
        <div class="col-auto">
          <img src="<?=url("/img/stripe/" . $card['Brand'] . ".png")?>" srcset="<?=url("/img/stripe/" . $card['Brand'] . "@2x.png")?> 2x, <?=url("/img/stripe/" . $card['Brand'] . "@3x.png")?> 3x" style="width:48px;"> <span class="sr-only"><?=htmlspecialchars(getCardBrand($card['Brand']))?></span>
        </div>
        <div class="col-auto">
          <h1 class="h1 my-0">
