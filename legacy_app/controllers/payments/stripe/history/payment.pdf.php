...
if ($pm == null || ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] != 'Admin' && $pm['User'] != $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID'])) {
  halt(404);
}
...
<html>
  ...
  <body>
    ...
    <p>
      Thank you for your payment to <?=htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME'))?>.
    </p>
