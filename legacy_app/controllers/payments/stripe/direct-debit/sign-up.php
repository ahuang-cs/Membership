...
// UPDATING
$customer = nezamy_app()->user->getStripeCustomer();
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-8">
      ...
      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['StripeDDError']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['StripeDDError']) { ?>
      ...
      <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['StripeDDError']);
      } ?>
