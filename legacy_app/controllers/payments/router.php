...
$this->group('/mandates', function () {
	...
	if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == "Parent" || $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == "Admin") {
...
if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == "Galas") {
	$this->get(['/', '/galas'], function () {
...
if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == "Galas" || $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == "Admin") {
...
if (getenv('STRIPE') && nezamy_app()->tenant->getStripeAccount()) {
	...
	*/
	...
	if (nezamy_app()->tenant->getBooleanKey('ALLOW_STRIPE_DIRECT_DEBIT_SET_UP') || nezamy_app()->tenant->getBooleanKey('USE_STRIPE_DIRECT_DEBIT')) {
