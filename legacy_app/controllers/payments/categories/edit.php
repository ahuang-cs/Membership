  ...
  <div class="row">
    <div class="col-lg-8">
      <form method="post" class="needs-validation" novalidate>
        ...
        <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NewCategorySuccess'])) { ?>
        ...
        <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['NewCategorySuccess']);
        } ?>

        <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SaveCategorySuccess'])) { ?>
          <div class="alert alert-success">
            <p class="mb-0">
              <strong>Success</strong>
            </p>
        ...
        <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SaveCategorySuccess']);
        } ?>

        <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SaveCategoryError'])) { ?>
          <div class="alert alert-danger">
            <p class="mb-0">
              <strong>Error</strong>
            </p>
            <p class="mb-0">
              <?= htmlspecialchars($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SaveCategoryError']) ?>
            </p>
          </div>
        <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['SaveCategoryError']);
        } ?>
