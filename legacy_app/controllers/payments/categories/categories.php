...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-8">
      ...
      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['HideCategorySuccess'])) { ?>
        <div class="alert alert-success">
          <p class="mb-0">
            <strong>Category hidden successfully</strong>
          </p>
          <p class="mb-0">
            <em><?= htmlspecialchars($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['HideCategorySuccess']) ?></em> will no longer be shown as an option for future payments.
          </p>
        </div>
      <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['HideCategorySuccess']);
      } ?>
