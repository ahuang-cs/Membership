...
if (!isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['GC-Setup-Status']) || $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['GC-Setup-Status'] == null) {
  halt(404);
}

$pagetitle = "You've setup a Direct Debit";
if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['GC-Setup-Status'] != 'success') {
...
<div class="container">
  <div class="row">
    <div class="col-lg-8">
      <?php if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['GC-Setup-Status'] == 'success' || $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['GC-Setup-Status'] == 'redirect_flow_already_completed') { ?>
      ...
      <p>GoCardless handles direct debit payments for <?=htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME'))?>.</p>
      ...
      <?php } else if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['GC-Setup-Status'] == 'redirect_flow_incomplete') { ?>
...
$_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['GC-Setup-Status'] = null;
unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['GC-Setup-Status']);