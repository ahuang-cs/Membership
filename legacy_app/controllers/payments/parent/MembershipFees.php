...
$info = null;
if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] != 'Parent' && isset($id) && $id != null) {
  $user = $id;
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-8">
      <h1>Membership fees<?php if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] != 'Parent') { ?> for <?= htmlspecialchars($info['Forename']) ?><?php } ?></h1>
