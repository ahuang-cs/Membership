<style>
  ...
  * {
  ...
  <?php if (!nezamy_app()->tenant->isCLS()) { ?>
    .primary {
      color: <?=htmlspecialchars(nezamy_app()->tenant->getKey('SYSTEM_COLOUR'))?>;
    }
    .primary-box {
      background-color: <?=htmlspecialchars(nezamy_app()->tenant->getKey('SYSTEM_COLOUR'))?>;
    }
    a, a:hover, a:active, a:visited {
      color: <?=htmlspecialchars(nezamy_app()->tenant->getKey('SYSTEM_COLOUR'))?>;
      text-decoration: underline;
  ...
  <?php if (nezamy_app()->tenant->getKey('SYSTEM_COLOUR') && getContrastColor(nezamy_app()->tenant->getKey('SYSTEM_COLOUR'))) { ?>
    .primary-box {
      color: #000;
    }
  <?php } ?>
