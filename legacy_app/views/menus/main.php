...
if (isset($use_website_menu)) {
  define('USE_CLS_MENU', $use_website_menu && nezamy_app()->tenant->isCLS());
}
...
if (!function_exists('chesterStandardMenu')) {
  function chesterStandardMenu()
  {
    ...
    $canPayByCard = false;
    if (getenv('STRIPE') && nezamy_app()->tenant->getStripeAccount() && nezamy_app()->tenant->getBooleanKey('GALA_CARD_PAYMENTS_ALLOWED')) {
      $canPayByCard = true;
    }
...
?>
    ...
    <?php if (!(isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID']) && user_needs_registration($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID'])) && (!isset($use_website_menu) || !$use_website_menu)) { ?>
      <div class="collapse navbar-collapse offcanvas-collapse" id="chesterNavbar">
        <ul class="navbar-nav mr-auto">
          <?php if (!empty($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LoggedIn'])) { ?>
            <li class="nav-item">
            ...
            <?php if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == "Parent") { ?>
              ...
              $getSwimmers->execute([$_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID']]);
              ?>
              ...
              <?php } ?>
              <?php if (nezamy_app()->tenant->getKey('ASA_CLUB_CODE') != 'UOSZ') { ?>
                <li class="nav-item">
            ...
            <?php } else { ?>
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="swimmerDropdown">
                  ...
                  <?php } ?>
                  <?php if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] != "Galas") { ?>
            ...
            <?php if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] != "Parent") { ?>
              <?php if (
                $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == "Admin" ||
                $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == "Galas"
              ) { ?>
                <li class="nav-item dropdown">
              ...
              <?php if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == "Admin") { ?>
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="paymentsAdminDropdown">
                    ...
                    <?php if (getenv('STRIPE') && nezamy_app()->tenant->getStripeAccount()) { ?>
                      <div class="dropdown-divider"></div>
              ...
              <?php } ?>
              <?php if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == "Admin" || $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == "Coach" || $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == "Galas") { ?>
                <li class="nav-item dropdown">
            ...
            <?php if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == 'Parent' && $haveSquadReps) { ?>
              <li class="nav-item">
            ...
            <?php } ?>
            <?php if ($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel'] == "Parent" && nezamy_app()->tenant->getKey('ASA_CLUB_CODE') != 'UOSZ') {
              $hasMandate = userHasMandates($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID']);
            ...
            ?>
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="paymentsParentDropdown">
                  ...
                  <?php if (nezamy_app()->tenant->getGoCardlessAccessToken() && $hasMandate && !stripeDirectDebit(true)) { ?>
                    <a class="dropdown-item" href="<?= autoUrl("payments/mandates") ?>">My Bank Account (Old System)</a>
                  <?php } else if (nezamy_app()->tenant->getGoCardlessAccessToken() && !stripeDirectDebit(true)) { ?>
                  ...
                  <?php if (getenv('STRIPE') && nezamy_app()->tenant->getStripeAccount()) { ?>
                    <?php if (nezamy_app()->tenant->getGoCardlessAccessToken()) { ?>
                      <div class="dropdown-divider"></div>
                    <?php } ?>
            ...
            <?php } ?>
            <?php if (isset(nezamy_app()->user) && nezamy_app()->user->hasPermission('Admin')) { ?>
              <li class="nav-item dropdown">
          ...
          <?php if (empty($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LoggedIn'])) { ?>
            ...
            <?php if (isset(nezamy_app()->tenant) && nezamy_app()->tenant->getKey('ASA_CLUB_CODE') == 'UOSZ' && false) { ?>
              <li class="nav-item">
              ...
              <div class="dropdown-menu dropdown-menu-right">
                ...
                if (sizeof($perms) > 1) { ?>
                  ...
                  <?php foreach ($perms as $perm => $name) { ?>
                    <a class="dropdown-item" href="<?= autoUrl("account-switch?type=" . urlencode($perm)) ?>"><?= htmlspecialchars($name) ?><?php if ($perm == $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AccessLevel']) { ?> <i class="text-primary fa fa-check-circle fa-fw" aria-hidden="true"></i><?php } ?></a>
                  <?php } ?>
                  <div class="dropdown-divider"></div>
                <?php } ?>
                <?php if (isset(nezamy_app()->tenant) && nezamy_app()->tenant->getKey('ASA_CLUB_CODE') == 'UOSZ') { ?>
