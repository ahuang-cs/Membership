...
if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['EnteredUsername'])) {
...
<div class="container">
  <h1 class="mb-5">Sign in using your <?= htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME')) ?> Account</h1>
  <div class="row">
    <div class="col-md-8 col-lg-5">
      ...
      <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['ErrorAccountLocked']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['ErrorAccountLocked']) { ?>
        <div class="alert alert-danger">
      ...
      <?php unset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['ErrorAccountLocked']);
      } ?>
