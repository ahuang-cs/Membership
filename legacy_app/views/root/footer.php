          ...
          <div class="col-lg-6">
            <div class="row">
              <div class="col-sm-6">
                ...
                <p><i class="fa fa-flag fa-fw" aria-hidden="true"></i> <a class="text-white" href="<?= htmlspecialchars('mailto:support@myswimmingclub.uk') ?>">Report an issue with this page</a>
                </p>
              </div>
              <div class="col-sm-6">
                <ul class="list-unstyled cls-global-footer-link-spacer">
                  <?php if (!isset($_SESSION['SCDS-SuperUser'])) { ?>
                    ...
                    <li>
                      <a class="text-white" href="<?= htmlspecialchars(autoUrl("admin")) ?>" title="Sign in to your admin account">
                        Login
                      </a>
                    </li>
                  <?php } ?>
            ...
            <div class="row">
              <div class="col-sm-6 col-lg-6">
                <ul class="list-unstyled cls-global-footer-link-spacer">
                  ...
                  <li>
                    <a class="text-white" href="<?= htmlspecialchars(autoUrl('help-and-support')) ?>" title="Help and Support">
                      Help and Support
                    </a>
                  </li>
                  <li>
