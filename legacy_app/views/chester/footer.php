        ...
        <div class="col-lg-6">
          <div class="row">
            <div class="col">
              ...
              <p><i class="fa fa-flag fa-fw" aria-hidden="true"></i> <a href="<?= autoUrl("reportanissue?url=" . urlencode(nezamy_app('request')->curl)) ?>">Report an issue with this page</a>
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-sm-6 col-lg-6">
              <ul class="list-unstyled cls-global-footer-link-spacer">
                ...
                <li>
                  <a href="<?= autoUrl("privacy") ?>" target="_blank" title="<?= htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME')) ?> Privacy Policy">
                    Our Privacy Policy
                  </a>
                </li>
                <li>
            ...
            <div class="col-sm-6 col-lg-6">
              <ul class="list-unstyled cls-global-footer-link-spacer">
                ...
                <li><a title="<?= htmlspecialchars($districts[nezamy_app()->tenant->getKey('ASA_DISTRICT')]['title']) ?>" target="_blank" href="<?= htmlspecialchars($districts[nezamy_app()->tenant->getKey('ASA_DISTRICT')]['website']) ?>"><?= htmlspecialchars($districts[nezamy_app()->tenant->getKey('ASA_DISTRICT')]['name']) ?></a></li>
                <li><a title="<?= htmlspecialchars($counties[nezamy_app()->tenant->getKey('ASA_COUNTY')]['title']) ?>" target="_blank" href="<?= htmlspecialchars($counties[nezamy_app()->tenant->getKey('ASA_COUNTY')]['website']) ?>"><?= htmlspecialchars($counties[nezamy_app()->tenant->getKey('ASA_COUNTY')]['name']) ?></a></li>
              </ul>
