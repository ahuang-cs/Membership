...
if (!isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AlphaBeta'])) {
  if (rand() < 0.5) {
    $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AlphaBeta'] = false;
  } else {
    $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AlphaBeta'] = true;
  }
}
...
<?php if (false /*$_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['AlphaBeta']*/) { ?>
  <style>
    h1 {
      background: #bd0000;
      padding: 1rem;
  ...
  <div class="d-print-none">
    ...
    <?php if ($_SESSION['Browser']['Name'] == "Internet Explorer") { ?>
      <div class="bg-warning py-3 d-print-none">
        <div class="<?= $container_class ?>">
          ...
          <p class="mb-0">
            <?= htmlspecialchars(nezamy_app()->tenant->getKey('CLUB_NAME')) ?> recommends you <strong><a class="text-dark" href="https://www.firefox.com">install
    ...
    <div class="text-white py-2 top-bar bg-primary-dark hide-a-underline" style="font-size:0.875rem;">
      <div class="<?= $container_class ?> d-flex">
        ...
        <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LoggedIn']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['LoggedIn']) { ?>
    ...
    <?php if (true || !isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['PWA']) || !$_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['PWA']) { ?>
      <div class="bg-primary <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID']) && user_needs_registration($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['UserID'])) { ?>d-lg-none<?php } ?>">
        <div class="<?= $container_class ?>">
        <?php } ?>
        <nav class="navbar <?php if (isset($_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['PWA']) && $_SESSION['TENANT-' . nezamy_app()->tenant->getId()]['PWA']) { ?><?php } ?>  navbar-expand-lg navbar-dark bg-primary
